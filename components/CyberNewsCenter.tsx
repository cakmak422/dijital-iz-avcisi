  ...
  useEffect(() => {
    ...
    async function loadNews() {
      try {
        ...
        // Fallback mock haberler ekranda kalır.
      }
    }
      ...
      <div className={HOME_SECTION_CONTAINER}>
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          {latestNews.map((post, index) => (
            <article className="group flex h-full flex-col overflow-hidden rounded-lg border border-slate-200 bg-slate-50 shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-300 hover:bg-white hover:shadow-md dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10" key={post.id}>

...
export function BrandLogo({ subtitle }: { subtitle?: string }) {
  return (
    <Link className="flex min-w-0 items-center gap-3" href="/" aria-label="Dijital İz Avcısı">
      ...
      <span className="hidden min-w-0 sm:block">
        <span className="block text-sm font-bold leading-4">Dijital İz Avcısı</span>
